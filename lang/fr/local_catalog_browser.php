...
// Label for the course title filter position setting.
$string['setting_order_titlefilter'] = 'Position du filtre par titre';

// Description for the course title filter position setting.
$string['setting_order_titlefilter_desc'] = 'Position du filtre par titre dans le formulaire de recherche. 1 = premier, 2 = deuxième, etc. Toute valeur supérieure au nombre total de filtres actifs, ou -1, le place en dernière position. En cas de conflit avec un autre filtre natif, le titre est placé en premier.';

// Label for the category filter position setting.
$string['setting_order_categoryfilter'] = 'Position du filtre par catégorie';

// Description for the category filter position setting.
$string['setting_order_categoryfilter_desc'] = 'Position du filtre par catégorie Moodle dans le formulaire de recherche. 1 = premier, 2 = deuxième, etc. Toute valeur supérieure au nombre total de filtres actifs, ou -1, le place en dernière position. En cas de conflit, la catégorie est placée avant les tags.';

// Label for the tag filter position setting.
$string['setting_order_tagfilter'] = 'Position du filtre par tags';

// Description for the tag filter position setting.
$string['setting_order_tagfilter_desc'] = 'Position du filtre par tags dans le formulaire de recherche. 1 = premier, 2 = deuxième, etc. Toute valeur supérieure au nombre total de filtres actifs, ou -1, le place en dernière position. En cas de conflit, les tags sont placés en dernier.';

// Warning displayed in the settings when two native filters share the same
// configured position. Resolved automatically by priority: title > category > tags.
$string['setting_order_conflict'] = 'Deux filtres natifs ou plus (titre, catégorie, tags) ont été assignés à la même position. Les positions ont été ajustées automatiquement : en cas de conflit, le titre est placé avant la catégorie, qui est placée avant les tags.';
